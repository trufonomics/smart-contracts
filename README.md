...
89 tests (84 vault + 5 factory), including 4 fuzz tests. Covers constructor validation, ERC-4626 operations, bridge flows, PnL bounds, operator transfer, performance fees (HWM recovery, retroactive charge prevention, deposit neutrality), skim, pause, full lifecycle scenarios, and factory deployment.
...
See [docs/about.md](docs/about.md) for a line-by-line contract walkthrough.
